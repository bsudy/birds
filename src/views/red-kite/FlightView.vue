<template>
  <div class="font-body text-on-surface selection:bg-primary-fixed-dim selection:text-on-primary-fixed">
    ...
    <main class="pb-12 px-6 max-w-7xl mx-auto">
      <!-- Hero Section -->
      <SpecimenHero image-src="/red-kite-hunting-flight.jpg" image-alt="Red Kite soaring in flight" :flip="true">
      ...
      <section class="mb-24">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            <img
              src="/red-kite-hunting-flight.jpg"
              alt=""
      ...
      >
        <div class="relative w-full max-w-3xl aspect-video bg-black rounded-xl overflow-hidden shadow-2xl">
          ...
          <iframe
            ...
            src="https://www.youtube.com/embed/Jis9kB9bnBc?autoplay=1"
      ...
      <section class="bg-surface-container-low rounded-xl p-12 mb-24">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div class="space-y-2">
            <span class="block text-4xl font-headline text-primary">175 <span class="text-lg font-body text-on-surface-variant">cm</span></span>
          ...
          <div class="space-y-2">
            <span class="block text-4xl font-headline text-primary">50 <span class="text-lg font-body text-on-surface-variant">km/h</span></span>
          ...
          <div class="space-y-2">
            <span class="block text-4xl font-headline text-primary">80 <span class="text-lg font-body text-on-surface-variant">km/h</span></span>
